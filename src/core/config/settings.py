...
class Settings(BaseSettings):
    ...
    app_name: str = Field(
        default="Are You Not Entertained",
    ...
    use_json_logging: bool = Field(
        default=False,
        description="Use JSON formatted logs (recommended for production)"
    )
    ...
    data_dir: Optional[Path] = Field(
        default=None,
        description="Data directory (defaults to project_root/data)"
    )
    ...
    models_dir: Optional[Path] = Field(
        default=None,
        description="Models directory (defaults to project_root/models)"
    )
    
    logs_dir: Optional[Path] = Field(
        default=None,
        description="Logs directory (defaults to project_root/logs)"
    )
    ...
    omdb_api_key: Optional[str] = Field(
        default=None,
        description="Open Movie Database (OMDB) API key"
    )
